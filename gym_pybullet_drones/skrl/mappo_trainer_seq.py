...
NUM_AGENTS = 5
env_pz = PZMultiHover(num_drones=NUM_AGENTS, 
...
memories = {agent: RandomMemory(memory_size=300, num_envs=1, device=device) for agent in env_skrl.possible_agents}
...
trainer = SequentialTrainer(env=env_skrl, agents=mappo, cfg=mappo_cfg)
